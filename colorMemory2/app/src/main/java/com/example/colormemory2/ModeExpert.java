...
public class ModeExpert extends AppCompatActivity {

    Random rand = new Random();
    private Button[] btns = new Button[20];
    int[] nombreAleatoire = new int[20];
    int[] PlayerBlock = new int[20];
    int maxBlock = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btns[15] = findViewById(R.id.btn16);
        btns[16] = findViewById(R.id.btn17);
        btns[17] = findViewById(R.id.btn18);
        btns[18] = findViewById(R.id.btn19);
        btns[19] = findViewById(R.id.btn20);
        ...
        btns[15].setBackgroundColor(Color.RED);
        btns[16].setBackgroundColor(Color.GREEN);
        btns[17].setBackgroundColor(Color.BLUE);
        btns[18].setBackgroundColor(Color.YELLOW);
        btns[19].setBackgroundColor(Color.RED);
    ...
    public void  game()
    {
        if(NbVie != 0) {
            ...
            if (maxBlock > 5) {
                handler.postDelayed(ButtonColor, 12400);
                handler.postDelayed(ButtonColorNormal, 12700);
            }
            if (maxBlock > 14) {
                handler.postDelayed(ButtonColor, 13000);
                handler.postDelayed(ButtonColorNormal, 13400);
            }
            if (maxBlock > 14) {
                handler.postDelayed(ButtonColor, 13700);
                handler.postDelayed(ButtonColorNormal, 14100);
            }
            if (maxBlock > 14) {
                handler.postDelayed(ButtonColor, 14400);
                handler.postDelayed(ButtonColorNormal, 14800);
            }
            if (maxBlock > 14) {
                handler.postDelayed(ButtonColor, 15100);
                handler.postDelayed(ButtonColorNormal, 15500);
            }
            CLickJoueur();

            if((niveau>1)&&(niveau<15))
            {
